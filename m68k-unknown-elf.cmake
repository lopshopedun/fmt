...
set(CMAKE_CXX_FLAGS_DEBUG "-${CPUFLAG} -malign-int -std=gnu++14 -gdwarf-2 -Wall -Wextra -pedantic -fno-rtti -fexceptions -D_DEBUG -falign-functions=4 -g -ffunction-sections -fdata-sections -D$ENV{PLATFORM} -D${CPU_TYPE} -DNBMINGW ${CXX_NBINCLUDE} ${EXTRADBCXXFLAGS}" CACHE STRING "C++ Debug Flags")

set(CMAKE_CXX_FLAGS_RELEASE "-${CPUFLAG} -malign-int -std=gnu++14 -gdwarf-2 -Wall -Wextra -pedantic -fno-rtti -fexceptions -falign-functions=4 -O2 -ffunction-sections -fdata-sections -D$ENV{PLATFORM} -D${CPU_TYPE} -DNBMINGW ${CXX_NBINCLUDE} ${EXTRACXXFLAGS}" CACHE STRING "C++ Release Flags")
